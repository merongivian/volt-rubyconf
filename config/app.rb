...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-workshop.com'
  config.app_name = 'Volt-workshop'
  config.mailer.from = 'Volt-workshop <no-reply@volt-workshop.com>'
  ...
  #
  config.app_secret = 'gJL4C2CTUifyHChYL7EQcjfLRiusgMZorwBtyrL1VCsvXn40LllQBKnSJbAYWWYYvAk'
